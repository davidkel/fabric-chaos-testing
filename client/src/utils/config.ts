...
export const statusTimeout = env.get('STATUS_TIMEOUT').default(60000).asIntPositive();
export const grpcTimeout = env.get('GRPC_TIMEOUT').default(20000).asIntPositive();
export const endorseTimeout = env.get('ENDORSE_TIMEOUT').default(30000).asIntPositive();
export const submitTimeout = env.get('SUBMIT_TIMEOUT').default(10000).asIntPositive();
export const evaluateTimeout = env.get('EVALUATE_TIMEOUT').default(30000).asIntPositive();
